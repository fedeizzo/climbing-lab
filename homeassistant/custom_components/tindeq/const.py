...
SENSOR_TYPES = {
    ...
    # Peakload metrics
    "peakload_left_current": {
        "name": "Peakload Left Current",
        "unit": "kg",
        "icon": "mdi:hand-back-left",
        "device_class": None,
        "state_class": "measurement",
    },
    "peakload_right_current": {
        "name": "Peakload Right Current",
        "unit": "kg",
    ...
    "peakload_left_trend": {
        "name": "Peakload Left Trend",
        "unit": "%",
        "icon": "mdi:trending-up",
        "device_class": None,
        "state_class": "measurement",
    },
    "peakload_right_trend": {
        "name": "Peakload Right Trend",
        "unit": "%",
        "icon": "mdi:trending-up",
        "device_class": None,
        "state_class": "measurement",
